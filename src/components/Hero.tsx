...
export default function Hero() {
    return (
        <>
            <section className="flex-1 flex flex-col items-center gap-10 px-6 justify-around">
                <div className="flex flex-col items-center text-center max-w-xl sm:max-w-2xl md:max-w-3xl lg:max-w-4xl gap-4">
